...
public class Twist {
	...
	public Twist(String questionsFilename){
	  ...
	  public void starter(){
		...
		System.out.println("============================================");
		System.out.println("*****Welcome to TwistWord Enjoy!!!****");
		reset();
		prepareNextQuestion();
		while (!isGameOver()){
			...
			System.out.println("These are the jumbled words:");
			printQuestion();
			...
			switch (tryWord(word)) {
				...
				case 1: System.out.println("Correct!"); 
						answers.add(word); 
						break;
				case -1: System.out.println("Word is invalid"); break;
				default: break;
			}
